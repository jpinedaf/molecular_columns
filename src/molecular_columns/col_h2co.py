...
@u.quantity_input
def Q_p_H2CO_i(index: int, Tex: u.K = 5 * u.K) -> float:
    """
...
@u.quantity_input
def Q_p_H2CO(Tex: u.K = 5 * u.K) -> float:
    """
...
@u.quantity_input
def Q_o_H2CO_i(index: int, Tex: u.K = 5 * u.K) -> float:
    """
    The function returns the individual elements of the partition function:
    the occupancy of each level dependent on degeneracy and energy level
    for a given excitation temperature.
...
@u.quantity_input
def Q_o_H2CO(Tex: u.K = 5 * u.K) -> float:
    """
